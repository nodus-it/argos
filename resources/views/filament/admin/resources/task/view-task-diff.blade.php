<x-filament-panels::page>
    ...
    {{-- Stat Summary --}}
    @if(trim($stat) !== '')
        <div class="rounded-xl border border-slate-700 bg-slate-900 px-4 py-3 font-mono text-xs text-slate-300 whitespace-pre-wrap leading-5">{{ $stat }}</div>
    @endif
                        ...
                        <table class="w-full border-collapse font-mono text-xs leading-5">
                            @foreach($file['hunks'] as $hunk)
                                ...
                                <tr class="bg-sky-950/30 border-t border-b border-sky-900/40">
                                    ...
                                    <td class="w-12 px-2 py-1 text-slate-600 select-none text-right"></td>
                                    <td class="px-3 py-1 text-sky-400/80 font-semibold">{{ $hunk['header'] }}</td>
                                </tr>
                                {{-- Lines --}}
