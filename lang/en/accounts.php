...
return [
    ...
    'blade' => [
        ...
        'connect_gitlab' => 'Connect with GitLab',
        'gitlab_not_configured_description' => 'No GitLab OAuth app configured yet. Create one to enable the GitLab integration.',
        'bitbucket_not_connected_description' => 'Connect your Bitbucket account to select repos and branches directly.',
        'connect_bitbucket' => 'Connect with Bitbucket',
        'bitbucket_not_configured_description' => 'No Bitbucket OAuth app configured yet. Create one to enable the Bitbucket integration.',
        ...
        'connect_linear' => 'Connect with Linear',
        'linear_not_configured_description' => 'No Linear OAuth app configured yet. Create one to enable the Linear integration.',
        'setup_link' => 'Setup guide',
        'create_oauth_app' => 'Create OAuth app',
        'github_not_configured_description' => 'No GitHub OAuth app configured yet. Create one to enable the GitHub integration.',
    ],
];
