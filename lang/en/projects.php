...
return [
    ...
    'fields' => [
        ...
        'worker_services_label' => 'Backing services for tests',
        'worker_services_helper' => 'Argos boots the selected services ephemerally per implement run (own network, removed afterwards) and injects their credentials. Reachable at db (MySQL) and redis — projects using standard names (DB_HOST, …) need nothing else; wire custom names via the placeholders below.',
        'mysql_database_label' => 'MySQL database',
        'mysql_username_label' => 'MySQL user',
        'mysql_password_label' => 'MySQL password',
        'env_placeholders_heading' => 'Available placeholders',
        'env_placeholders_body' => 'Usable in the values below — Argos substitutes the service coordinates:',
