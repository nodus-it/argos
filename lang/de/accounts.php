...
return [
    ...
    'blade' => [
        ...
        'connect_gitlab' => 'Mit GitLab verbinden',
        'gitlab_not_configured_description' => 'Noch keine GitLab-OAuth-App konfiguriert. Lege eine an, um die GitLab-Integration zu aktivieren.',
        'bitbucket_not_connected_description' => 'Verbinde deinen Bitbucket-Account, um Repos und Branches direkt auszuwählen.',
        'connect_bitbucket' => 'Mit Bitbucket verbinden',
        'bitbucket_not_configured_description' => 'Noch keine Bitbucket-OAuth-App konfiguriert. Lege eine an, um die Bitbucket-Integration zu aktivieren.',
        ...
        'connect_linear' => 'Mit Linear verbinden',
        'linear_not_configured_description' => 'Noch keine Linear-OAuth-App konfiguriert. Lege eine an, um die Linear-Integration zu aktivieren.',
        'setup_link' => 'Setup-Anleitung',
        'create_oauth_app' => 'OAuth-App anlegen',
        'github_not_configured_description' => 'Noch keine GitHub-OAuth-App konfiguriert. Lege eine an, um die GitHub-Integration zu aktivieren.',
    ],
];
