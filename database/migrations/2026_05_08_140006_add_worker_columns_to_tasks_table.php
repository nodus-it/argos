...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('tasks', function (Blueprint $table): void {
            $table->foreignUlid('worker_stack_id_override')
                ...
                ->nullOnDelete();
            $table->foreignUlid('worker_agent_id_override')
                ->nullable()
                ->after('worker_stack_id_override')
                ->constrained('worker_agents')
                ->nullOnDelete();
            $table->json('worker_config_override')->nullable()->after('worker_agent_id_override');
    ...
    public function down(): void
    {
        Schema::table('tasks', function (Blueprint $table): void {
            ...
            $table->dropConstrainedForeignId('worker_agent_id_override');
            $table->dropConstrainedForeignId('worker_stack_id_override');
            $table->dropColumn(['worker_config_override', 'agent_config']);
        });
    }
};
