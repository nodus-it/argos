...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Server-to-server REST API onto the same task workflow as the '
            .'Argos UI and MCP server. Authenticate with a Sanctum bearer token '
            .'(personal access token) carrying the required abilities '
