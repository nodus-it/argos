...
class GitLabTaskServiceTest extends TestCase
{
    public function test_list_issues_uses_bearer_auth(): void
    {
        ...
        (new GitLabTaskService('glpat-tok'))->listIssues('acme', 'widget');
    ...
    public function test_list_issues_returns_array(): void
    {
        ...
        $result = (new GitLabTaskService('tok'))->listIssues('acme', 'widget');
    ...
    public function test_get_issue_merges_notes_and_emojis(): void
    {
        ...
        $result = (new GitLabTaskService('tok'))->getIssue('acme', 'widget', 42);
    ...
    public function test_get_issue_gracefully_handles_missing_award_emoji(): void
    {
        ...
        $result = (new GitLabTaskService('tok'))->getIssue('acme', 'widget', 1);
    ...
    public function test_create_issue_posts_correct_payload(): void
    {
        ...
        $result = (new GitLabTaskService('tok'))->createIssue(
    ...
    public function test_create_comment_posts_note(): void
    {
        ...
        $result = (new GitLabTaskService('tok'))->createComment('acme', 'widget', 5, 'Hello');
    ...
    public function test_no_private_token_header_sent(): void
    {
        ...
        (new GitLabTaskService('tok'))->listIssues('acme', 'widget');
    ...
    public function test_self_hosted_uses_custom_instance_url(): void
    {
        ...
        (new GitLabTaskService('tok', 'https://git.example.com'))->listIssues('acme', 'widget');
