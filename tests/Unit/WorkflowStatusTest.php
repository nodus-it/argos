...
class WorkflowStatusTest extends TestCase
{
    ...
    {
        $this->assertSame(WorkflowStatus::ConceptReview, WorkflowStatus::afterPhase('concept', 'completed'));
    }

    public function test_concept_failed_yields_failed(): void
    {
        $this->assertSame(WorkflowStatus::Failed, WorkflowStatus::afterPhase('concept', 'failed'));
    }

    public function test_concept_quality_gate_failed_yields_failed(): void
    {
        $this->assertSame(WorkflowStatus::Failed, WorkflowStatus::afterPhase('concept', 'quality_gate_failed'));
    }

    public function test_implement_failed_yields_failed(): void
    {
        $this->assertSame(WorkflowStatus::Failed, WorkflowStatus::afterPhase('implement', 'failed'));
    }

    public function test_implement_quality_gate_failed_yields_failed(): void
    {
        $this->assertSame(WorkflowStatus::Failed, WorkflowStatus::afterPhase('implement', 'quality_gate_failed'));
    }

    public function test_push_completed_yields_in_review(): void
    {
        $this->assertSame(WorkflowStatus::InReview, WorkflowStatus::afterPhase('push', 'completed'));
    }

    public function test_push_failed_yields_failed(): void
    {
        $this->assertSame(WorkflowStatus::Failed, WorkflowStatus::afterPhase('push', 'failed'));
    }

    public function test_respond_completed_yields_in_review(): void
    {
        $this->assertSame(WorkflowStatus::InReview, WorkflowStatus::afterPhase('respond', 'completed'));
    }

    public function test_respond_failed_yields_failed(): void
    {
        $this->assertSame(WorkflowStatus::Failed, WorkflowStatus::afterPhase('respond', 'failed'));
    }
    ...
    public function test_implement_completed_returns_null(): void
    {
        ...
        $this->assertNull(WorkflowStatus::afterPhase('implement', 'completed'));
    }

    public function test_unknown_combination_returns_null(): void
    {
        $this->assertNull(WorkflowStatus::afterPhase('unknown', 'completed'));
        $this->assertNull(WorkflowStatus::afterPhase('concept', 'no_changes'));
    }
